...
class XAIService:
    ...
    def generate_explanation(
        ...
        if document_analysis.get("forgery_detected"):
            ...
            explanation_parts.append(f"  • {document_analysis.get('font_analysis', {}).get('details', '')}")
        ...
        if liveness_analysis.get("lip_sync_match"):
            explanation_parts.append("✓ PASSED: Live person detected")
            ...
            explanation_parts.append("✗ FAILED: Potential deepfake or pre-recorded video detected")
