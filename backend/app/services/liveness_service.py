...
class LivenessService:
    ...
    PHRASES = {
        ...
        "marathi": ["निळी मांजर", "लाल कार", "हिरवे झाड", "पिवळा सूर्य", "जांभळा चंद्र"],
        "telugu": ["నీలి పిల్లి", "ఎరుపు కారు", "ఆకుపచ్చ చెట్టు", "పసుపు సూర్యుడు", "ఊదా చంద్రుడు"],
        "kannada": ["ನೀಲಿ ಬೆಕ್ಕು", "ಕೆಂಪು ಕಾರು", "ಹಸಿರು ಮರ", "ಹಳದಿ ಸೂರ್ಯ", "ನೇರಳೆ ಚಂದ್ರ"],
        "malayalam": ["നീല പൂച്ച", "ചുവന്ന കാർ", "പച്ച മരം", "മഞ്ഞ സൂര്യൻ", "ധൂമ്രനൂൽ ചന്ദ്രൻ"],
        "bengali": ["নীল বিড়াল", "লাল গাড়ি", "সবুজ গাছ", "হলুদ সূর্য", "বেগুনি চাঁদ"]
    }
